...
void init_paging(void) {
    ...
    for (int i = 0; i < 1024; i++) {
        if(i == 1023) new_page_alloc_table_high[i] = (0x00400000 + (i * PAGE_SIZE))  | PAGE_WRITABLE;
        else new_page_alloc_table_high[i] = (0x00400000 + (i * PAGE_SIZE)) | PAGE_PRESENT | PAGE_WRITABLE;
    }
